...
def main(file_path1, file_path2, sheet_name, output_folder):
    ...
    df1 = pd.read_excel(file_path1, sheet_name=sheet_name, usecols=['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος'])
    ...
    if filtered_construction.empty and filtered_inspection.empty and filtered_bid.empty and filtered_new_flow.empty:
        ...
        data_df = pd.concat([merged_construction[['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'AGE', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'TYPE', 'ΤΗΛΕΦΩΝΟ ΠΑΡΑΓΓΕΛΙΑΣ', 'FLOOR', 'PILOT', 'A/K', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΠΕΛΑΤΗ', 'ΚΙΝΗΤΟ ΠΕΛΑΤΗ', 'ΣΤΑΘΕΡΟ ΠΕΛΑΤΗ', 'E-MAIL ΠΕΛΑΤΗ', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΚΙΝΗΤΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΣΤΑΘΕΡΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'E-MAIL ΔΙΑΧΕΙΡΙΣΤΗ', 'CREATED', 'BUILDING ID', 'BEP/FB CODE', 'BEP/FB PORT', 'BEP/FB TYPE']],
                              merged_inspection[['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'AGE', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'TYPE', 'ΤΗΛΕΦΩΝΟ ΠΑΡΑΓΓΕΛΙΑΣ', 'FLOOR', 'PILOT', 'A/K', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΠΕΛΑΤΗ', 'ΚΙΝΗΤΟ ΠΕΛΑΤΗ', 'ΣΤΑΘΕΡΟ ΠΕΛΑΤΗ', 'E-MAIL ΠΕΛΑΤΗ', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΚΙΝΗΤΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΣΤΑΘΕΡΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'E-MAIL ΔΙΑΧΕΙΡΙΣΤΗ', 'CREATED', 'BUILDING ID', 'BEP/FB CODE', 'BEP/FB PORT', 'BEP/FB TYPE']],
                              merged_bid[['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'AGE', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'TYPE', 'ΤΗΛΕΦΩΝΟ ΠΑΡΑΓΓΕΛΙΑΣ', 'FLOOR', 'PILOT', 'A/K', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΠΕΛΑΤΗ', 'ΚΙΝΗΤΟ ΠΕΛΑΤΗ', 'ΣΤΑΘΕΡΟ ΠΕΛΑΤΗ', 'E-MAIL ΠΕΛΑΤΗ', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΚΙΝΗΤΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΣΤΑΘΕΡΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'E-MAIL ΔΙΑΧΕΙΡΙΣΤΗ', 'CREATED', 'BUILDING ID', 'BEP/FB CODE', 'BEP/FB PORT', 'BEP/FB TYPE']],
                              merged_new_flow[['SR ID', 'sr_created', 'FIELDTASKTYPE', 'FIELDTASKSTATUS', 'full_adr', 'AGECLASS', 'pilot', 'customer', 'mobile', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'building Id']]], ignore_index=True)
        final_df = pd.concat([merged_construction[['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'TYPE', 'ΤΗΛΕΦΩΝΟ ΠΑΡΑΓΓΕΛΙΑΣ', 'ADDRESS', 'FLOOR', 'PILOT', 'A/K', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΠΕΛΑΤΗ', 'AGE', 'ΚΙΝΗΤΟ ΠΕΛΑΤΗ', 'ΣΤΑΘΕΡΟ ΠΕΛΑΤΗ', 'E-MAIL ΠΕΛΑΤΗ', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΚΙΝΗΤΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΣΤΑΘΕΡΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'E-MAIL ΔΙΑΧΕΙΡΙΣΤΗ', 'CREATED', 'BUILDING ID', 'BEP/FB CODE', 'BEP/FB PORT', 'BEP/FB TYPE']],
                              merged_inspection[['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'TYPE', 'ΤΗΛΕΦΩΝΟ ΠΑΡΑΓΓΕΛΙΑΣ', 'ADDRESS', 'FLOOR', 'PILOT', 'A/K', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΠΕΛΑΤΗ', 'AGE', 'ΚΙΝΗΤΟ ΠΕΛΑΤΗ', 'ΣΤΑΘΕΡΟ ΠΕΛΑΤΗ', 'E-MAIL ΠΕΛΑΤΗ', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΚΙΝΗΤΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΣΤΑΘΕΡΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'E-MAIL ΔΙΑΧΕΙΡΙΣΤΗ', 'CREATED', 'BUILDING ID', 'BEP/FB CODE', 'BEP/FB PORT', 'BEP/FB TYPE']],
                              merged_bid[['SR ID', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'TYPE', 'ΤΗΛΕΦΩΝΟ ΠΑΡΑΓΓΕΛΙΑΣ', 'ADDRESS', 'FLOOR', 'PILOT', 'A/K', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΠΕΛΑΤΗ', 'AGE', 'ΚΙΝΗΤΟ ΠΕΛΑΤΗ', 'ΣΤΑΘΕΡΟ ΠΕΛΑΤΗ', 'E-MAIL ΠΕΛΑΤΗ', 'ΌΝΟΜΑΤΕΠΩΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΚΙΝΗΤΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'ΣΤΑΘΕΡΟ ΔΙΑΧΕΙΡΙΣΤΗ', 'E-MAIL ΔΙΑΧΕΙΡΙΣΤΗ', 'CREATED', 'BUILDING ID', 'BEP/FB CODE', 'BEP/FB PORT', 'BEP/FB TYPE']],
                              merged_new_flow[['SR ID', 'sr_created', 'FIELDTASKTYPE', 'FIELDTASKSTATUS', 'full_adr', 'AGECLASS', 'pilot', 'customer', 'mobile', 'Τύπος Εργασίας', 'Ημερομηνία Δημιουργίας', 'Εργολάβος σε Ανάθεση', 'Κατάσταση', 'Ημερομηνία Ολοκλήρωσης', 'Αστικό Κέντρο', 'Διεύθυνση', 'Αριθμός', 'Έναρξη Ραντεβού', 'Τεχνικός έλεγχος', 'Κατηγορία Αιτήματος', 'building Id']]], ignore_index=True)
      ...
      # Create a summary DataFrame
        ...
        for sr_id in unique_sr_ids:
            ...
            row['Εργολάβος σε Ανάθεση'] = df1[df1['SR ID'] == sr_id]['Εργολάβος σε Ανάθεση'].values[0]
            autopsia_df = final_df[(final_df['SR ID'] == sr_id) & (final_df['Τύπος Εργασίας'] == 'ΑΥΤΟΨΙΑ FTTH')]
            if not autopsia_df.empty:
                row['Ημερομηνία Δημιουργίας (ΑΥΤΟΨΙΑ)'] = autopsia_df['Ημερομηνία Δημιουργίας'].max()
                row['Τύπος Εργασίας (ΑΥΤΟΨΙΑ)'] = autopsia_df[autopsia_df['Ημερομηνία Δημιουργίας'] == row['Ημερομηνία Δημιουργίας (ΑΥΤΟΨΙΑ)']]['Τύπος Εργασίας'].values[0]
                row['Κατάσταση (ΑΥΤΟΨΙΑ)'] = autopsia_df[autopsia_df['Ημερομηνία Δημιουργίας'] == row['Ημερομηνία Δημιουργίας (ΑΥΤΟΨΙΑ)']]['Κατάσταση'].values[0]
            else:
                row['Ημερομηνία Δημιουργίας (ΑΥΤΟΨΙΑ)'] = None
            ...
            if not kataskevi_df.empty:
                row['Ημερομηνία Δημιουργίας (ΚΑΤΑΣΚΕΥΗ)'] = kataskevi_df['Ημερομηνία Δημιουργίας'].max()
                row['Τύπος Εργασίας (ΚΑΤΑΣΚΕΥΗ)'] = kataskevi_df[kataskevi_df['Ημερομηνία Δημιουργίας'] == row['Ημερομηνία Δημιουργίας (ΚΑΤΑΣΚΕΥΗ)']]['Τύπος Εργασίας'].values[0]
                row['Κατάσταση (ΚΑΤΑΣΚΕΥΗ)'] = kataskevi_df[(kataskevi_df['Ημερομηνία Δημιουργίας'] == row['Ημερομηνία Δημιουργίας (ΚΑΤΑΣΚΕΥΗ)'])]['Κατάσταση'].values[0]
            else:
                row['Ημερομηνία Δημιουργίας (ΚΑΤΑΣΚΕΥΗ)'] = None
